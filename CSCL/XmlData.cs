...
namespace CSCL
{
	...
	public class XmlData
	{
		...
		/// F�r Bearbeitungen auf direkter XML Ebene
		/// </summary>
		...
		/// <summary>
		/// F�gt der Node ein Atribute hinzu
		/// </summary>
		...
		/// <summary>
		/// F�gt ein Element mit Inhalt hinzu
		/// </summary>
		/// <param name="path"></param>
		/// <param name="name"></param>
		...
		/// <summary>
		/// Gibt das erste Gefundende Element ru�ck welches dem Pfad entspricht
		/// als String zur�ck
		/// </summary>
		/// <param name="path"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Gibt das erste Gefundende Element zur�ck welches dem Pfad entspricht
		/// als XmlNode zur�ck
		/// </summary>
		/// <param name="path"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Gibt die Elemente eines bestimmten Pfades zur�ck
		/// </summary>
		/// <param name="path"></param>
		/// <returns></returns>
		...
		/// Pfades zur�ck welche ein bestimmtes Attribut 
		...
		/// <summary>
		/// Gibt die Anzahl der Tags des �bergebenen Pfades zur�ck
		/// </summary>
		/// <param name="path"></param>
		/// <returns></returns>
