using CSCL.Controls.SourceGrid.Cells.Models;
using System;
...
namespace CSCL.Controls.SourceGrid
{
    ...
    public class ArrayGrid : GridVirtual
	{
		...
		protected virtual void Bind()
		{
			...
			if (mDataSource != null)
			{
				mValueCell = new CSCL.Controls.SourceGrid.Cells.Virtual.CellVirtual();
...
//            ColumnFocusEnabled = true;
	...
	public class ArrayHeader : Cells.Virtual.Header
	{
		public ArrayHeader()
		{
			Model.AddModel(new CSCL.Controls.SourceGrid.Cells.Models.NullValueModel());
		}
	}
	#endregion
