...
namespace CSCL.Controls.SourceGrid.Planning
{
	/// <summary>
	...
	public class PlanningGrid : System.Windows.Forms.UserControl
	{
		...
		public void LoadPlanning(DateTime dateTimeStart, DateTime dateTimeEnd, int minAppointmentLength)
		{
            ...
            grid.Columns[0].AutoSizeMode = CSCL.Controls.SourceGrid.AutoSizeMode.None;
            grid.Columns[1].Width = 40;
            grid.Columns[1].AutoSizeMode = CSCL.Controls.SourceGrid.AutoSizeMode.None;
