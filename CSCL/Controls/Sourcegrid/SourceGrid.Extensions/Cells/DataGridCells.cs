...
namespace CSCL.Controls.SourceGrid.Cells.DataGrid
{
	public class Cell : Cells.Virtual.CellVirtual
	{
        ...
        public static Cells.ICellVirtual Create(Type type, bool editable)
        {
            ...
            if (type == typeof(bool))
                cell = new CSCL.Controls.SourceGrid.Cells.DataGrid.CheckBox();
            else
            {
                cell = new CSCL.Controls.SourceGrid.Cells.DataGrid.Cell();
                cell.Editor = CSCL.Controls.SourceGrid.Cells.Editors.Factory.Create(type);
            }
    ...
    public class ColumnHeader : Cells.Virtual.ColumnHeader
    {
        ...
        {
            Model.AddModel(new CSCL.Controls.SourceGrid.Cells.Models.ValueModel(pCaption));
        }
    }
