using CSCL.Controls.SourceGrid.Cells.Editors;
using System;
...
namespace CSCL.Controls.SourceGrid
{
	public class DataGridColumns : ColumnInfoCollection
	{
		...
		public DataGridColumn Add(string property,
		                          ...
		                          Type propertyType)
		{
			CSCL.Controls.SourceGrid.Cells.ICellVirtual cell = CSCL.Controls.SourceGrid.Cells.DataGrid.Cell.Create(propertyType, true);
		...
		public DataGridColumn Add(string property,
		                          ...
		                          EditorBase editor)
		{
			CSCL.Controls.SourceGrid.Cells.DataGrid.Cell cell = new CSCL.Controls.SourceGrid.Cells.DataGrid.Cell();
			cell.Editor = editor;
		...
		public DataGridColumn Add(string property,
		                          ...
		                          ICellVirtual cell)
		{
			CSCL.Controls.SourceGrid.DataGridColumn col = new DataGridColumn(Grid,
			                                                   new CSCL.Controls.SourceGrid.Cells.DataGrid.ColumnHeader(caption),
			                                                   cell,
			                                                   property);
			Insert(Count, col);
