	...
	public abstract class GridVirtual : CustomScrollControl
	{
		...
		protected virtual void OnRangePaint(RangePaintEventArgs e)
		{
			...
			try
			{
				...
				//Draw the decorators
				foreach (CSCL.Controls.SourceGrid.Decorators.DecoratorBase dec in Decorators)
				{
...
//		http://www.microsoft.com/middleeast/msdn/mirror.aspx
		...
		#region Controllers
		private Cells.Controllers.ControllerContainer mController = new CSCL.Controls.SourceGrid.Cells.Controllers.ControllerContainer();
