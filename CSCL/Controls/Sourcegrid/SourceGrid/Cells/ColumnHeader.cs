...
namespace CSCL.Controls.SourceGrid.Cells.Virtual
{
	/// <summary>
...
namespace CSCL.Controls.SourceGrid.Cells
{
	/// <summary>
	...
	public class ColumnHeader : Cell
	{
		...
		public System.Collections.IComparer SortComparer
		{
			...
			set{SortStatus = new CSCL.Controls.SourceGrid.Cells.Models.SortStatus(SortStatus.Style, value);}
		}
		...
		public DevAge.Drawing.HeaderSortStyle SortStyle
		{
			...
			set{SortStatus = new CSCL.Controls.SourceGrid.Cells.Models.SortStatus(value, SortStatus.Comparer);}
		}
