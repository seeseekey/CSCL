...
namespace CSCL.Controls
{
	...
	public class ShapeControl : System.Windows.Forms.Control
	{
		...
		[Category("Shape"), Description("Element is Dragable")]
		[BrowsableAttribute(true)]
		[EditorAttribute(typeof(ColorEditor), typeof(System.Drawing.Design.UITypeEditor))]
		public bool Dragable
		{
			get { return _dragable; }
			set { _dragable=value; this.Refresh(); }
		}
		...
		private void InitializeComponent()
		{
			...
			this.MouseMove+=new System.Windows.Forms.MouseEventHandler(this.ShapeControl_MouseMove);
			this.MouseDown+=new System.Windows.Forms.MouseEventHandler(this.ShapeControl_MouseDown);
		}
		...
		private void ShapeControl_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			if(_dragable)
			{
		...
		private void ShapeControl_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			if(_dragable)
			{
				if(e.Button.Equals(MouseButtons.Left))
