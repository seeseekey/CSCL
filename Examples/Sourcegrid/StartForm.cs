...
namespace WindowsFormsSample
{
	...
	public class StartForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.grid1.SpecialKeys = CSCL.Controls.SourceGrid.GridSpecialKeys.Default;
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			CSCL.Controls.SourceGrid.Cells.Controllers.Button linkEvents = new CSCL.Controls.SourceGrid.Cells.Controllers.Button();
			linkEvents.Executed += new EventHandler(linkEvents_Executed);

            //Category header
			CSCL.Controls.SourceGrid.Cells.Views.Cell categoryView = new CSCL.Controls.SourceGrid.Cells.Views.Cell();
            ...
            //Title header
            CSCL.Controls.SourceGrid.Cells.Views.ColumnHeader headerView = new CSCL.Controls.SourceGrid.Cells.Views.ColumnHeader();
			...
			grid1.Columns[0].AutoSizeMode = CSCL.Controls.SourceGrid.AutoSizeMode.EnableAutoSize;
			grid1.Columns[1].AutoSizeMode = CSCL.Controls.SourceGrid.AutoSizeMode.EnableAutoSize|CSCL.Controls.SourceGrid.AutoSizeMode.EnableStretch;
			grid1.AutoStretchColumnsToFitWidth = true;
			grid1.AutoSizeCells();
			grid1.Columns.StretchToFit();
		}

		private void LoadCategorySample(string category, CSCL.Controls.SourceGrid.Cells.Controllers.Button linkEvents, Type[] assemblyTypes, CSCL.Controls.SourceGrid.Cells.Views.IView categoryView, CSCL.Controls.SourceGrid.Cells.Views.IView headerView)
		{
			int row;
			...
			grid1[row, 0] = new CSCL.Controls.SourceGrid.Cells.Cell(category);
			...
			CSCL.Controls.SourceGrid.Cells.ColumnHeader header1 = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("Sample N°");
            header1.View = headerView;
			header1.AutomaticSortEnabled = false;
			grid1[row, 0] = header1;

			CSCL.Controls.SourceGrid.Cells.ColumnHeader header2 = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("Description");
			...
			for (int i = 0; i < assemblyTypes.Length; i++)
			{
				...
				if (attributes != null && attributes.Length > 0)
				{
					...
					if (sampleAttribute.Category == category)
					{
						row = grid1.RowsCount;
						grid1.Rows.Insert(row);
						grid1[row, 0] = new CSCL.Controls.SourceGrid.Cells.Cell( sampleAttribute.SampleNumber );
						grid1[row, 0].View = new CSCL.Controls.SourceGrid.Cells.Views.Cell();
						grid1[row, 0].View.TextAlignment = DevAge.Drawing.ContentAlignment.MiddleCenter;

						//Create a cell with a link
						grid1[row, 1] = new CSCL.Controls.SourceGrid.Cells.Link( sampleAttribute.Description );
			...
			CSCL.Controls.SourceGrid.RangeLoader headerRange = new CSCL.Controls.SourceGrid.RangeLoader(new CSCL.Controls.SourceGrid.Range(header1.Range.Start.Row, 0, header1.Range.Start.Row, 1));
			CSCL.Controls.SourceGrid.RangeLoader rangeToSort = new CSCL.Controls.SourceGrid.RangeLoader(new CSCL.Controls.SourceGrid.Range(header1.Range.Start.Row+1, 0, row, 1));
			CSCL.Controls.SourceGrid.Cells.Controllers.SortableHeader sortableController = new CSCL.Controls.SourceGrid.Cells.Controllers.SortableHeader(rangeToSort, headerRange);
		...
		{
			CSCL.Controls.SourceGrid.CellContext cellContext = (CSCL.Controls.SourceGrid.CellContext)sender;
			Type formType = (Type)((CSCL.Controls.SourceGrid.Cells.Cell)cellContext.Cell).Tag;
