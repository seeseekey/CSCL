...
namespace WindowsFormsSample.GridSamples
{
	...
	public class frmSample25 : System.Windows.Forms.Form
	{
		...
		public void AddLog(string type, string description)
		{
			...
			grid[row, 0] = new CSCL.Controls.SourceGrid.Cells.Cell(DateTime.Now);
			grid[row, 1] = new CSCL.Controls.SourceGrid.Cells.Cell(type);
			grid[row, 2] = new CSCL.Controls.SourceGrid.Cells.Cell(description);
		...
		private void frmSample25_Load(object sender, System.EventArgs e)
		{
            ...
            grid.Columns[0].AutoSizeMode = CSCL.Controls.SourceGrid.AutoSizeMode.EnableAutoSize;
            grid.Columns[1].AutoSizeMode = CSCL.Controls.SourceGrid.AutoSizeMode.EnableAutoSize;
            grid.Columns[2].AutoSizeMode = CSCL.Controls.SourceGrid.AutoSizeMode.EnableAutoSize | CSCL.Controls.SourceGrid.AutoSizeMode.EnableStretch;

            grid.FixedRows = 1;

			grid[0, 0] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("Date");
			grid[0, 1] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("Type");
			grid[0, 2] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("Description");

			grid.AutoStretchColumnsToFitWidth = true;
			grid.SelectionMode = CSCL.Controls.SourceGrid.GridSelectionMode.Row;
