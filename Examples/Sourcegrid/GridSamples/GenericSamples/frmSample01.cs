...
namespace WindowsFormsSample
{
	...
	public class frmSample01 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.grid1.OptimizeMode = CSCL.Controls.SourceGrid.CellOptimizeMode.ForRows;
            this.grid1.SelectionMode = CSCL.Controls.SourceGrid.GridSelectionMode.Cell;
		...
		//Editors
		private CSCL.Controls.SourceGrid.Cells.Editors.EditorBase mEditor_Id;
		private CSCL.Controls.SourceGrid.Cells.Editors.EditorBase mEditor_Name;
		private CSCL.Controls.SourceGrid.Cells.Editors.EditorBase mEditor_Address;
		private CSCL.Controls.SourceGrid.Cells.Editors.EditorBase mEditor_City;
		private CSCL.Controls.SourceGrid.Cells.Editors.EditorBase mEditor_BirthDay;
		private CSCL.Controls.SourceGrid.Cells.Editors.EditorBase mEditor_Country;
		private CSCL.Controls.SourceGrid.Cells.Editors.EditorBase mEditor_Price;

		//Views
        private CSCL.Controls.SourceGrid.Cells.Views.Cell mView_Price;

		//Controllers
		private CSCL.Controls.SourceGrid.Cells.Controllers.Button mController_Link;
		...
		private void frmSampleGrid1_Load(object sender, System.EventArgs e)
		{
			...
			grid1.SelectionMode = CSCL.Controls.SourceGrid.GridSelectionMode.Row;
			grid1.AutoStretchColumnsToFitWidth = true;
			grid1.Columns[0].AutoSizeMode = CSCL.Controls.SourceGrid.AutoSizeMode.None;
            ...
            //grid1.GridController.AddController(CSCL.Controls.SourceGrid.Controllers.SelectionDrag.Cut);
            //grid1.GridController.AddController(CSCL.Controls.SourceGrid.Controllers.SelectionDrop.Default);


			#region Create Grid Style, Views and Controllers
			//Views
			mView_Price = new CSCL.Controls.SourceGrid.Cells.Views.Cell();
			mView_Price.TextAlignment = DevAge.Drawing.ContentAlignment.MiddleRight;


			mController_Link = new CSCL.Controls.SourceGrid.Cells.Controllers.Button();
			mController_Link.Executed += new EventHandler(mController_Link_Click);
			#endregion

			#region Create Header Row and Editor
			CSCL.Controls.SourceGrid.Cells.Header l_00Header = new CSCL.Controls.SourceGrid.Cells.Header(null);
			grid1[0,0] = l_00Header;

            mEditor_Id = CSCL.Controls.SourceGrid.Cells.Editors.Factory.Create(typeof(int));
			mEditor_Id.EditableMode = CSCL.Controls.SourceGrid.EditableMode.Focus|CSCL.Controls.SourceGrid.EditableMode.AnyKey|CSCL.Controls.SourceGrid.EditableMode.SingleClick;
			grid1[0,1] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("ID (int)");

            mEditor_Name = CSCL.Controls.SourceGrid.Cells.Editors.Factory.Create(typeof(string));
			mEditor_Name.EditableMode = CSCL.Controls.SourceGrid.EditableMode.Focus|CSCL.Controls.SourceGrid.EditableMode.AnyKey|CSCL.Controls.SourceGrid.EditableMode.SingleClick;
			grid1[0,2] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("NAME (string)");

            mEditor_Address = CSCL.Controls.SourceGrid.Cells.Editors.Factory.Create(typeof(string));
			mEditor_Address.EditableMode = CSCL.Controls.SourceGrid.EditableMode.Focus|CSCL.Controls.SourceGrid.EditableMode.AnyKey|CSCL.Controls.SourceGrid.EditableMode.SingleClick;
			grid1[0,3] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("ADDRESS (string)");

            mEditor_City = CSCL.Controls.SourceGrid.Cells.Editors.Factory.Create(typeof(string));
			mEditor_City.EditableMode = CSCL.Controls.SourceGrid.EditableMode.Focus|CSCL.Controls.SourceGrid.EditableMode.AnyKey|CSCL.Controls.SourceGrid.EditableMode.SingleClick;
			grid1[0,4] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("CITY (string)");

			mEditor_BirthDay = CSCL.Controls.SourceGrid.Cells.Editors.Factory.Create(typeof(DateTime));
			mEditor_BirthDay.EditableMode = CSCL.Controls.SourceGrid.EditableMode.Focus|CSCL.Controls.SourceGrid.EditableMode.AnyKey|CSCL.Controls.SourceGrid.EditableMode.SingleClick;
			grid1[0,5] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("BIRTHDATE (DateTime)");

			mEditor_Country = new CSCL.Controls.SourceGrid.Cells.Editors.ComboBox(typeof(string),l_CountryList,false);
			mEditor_Country.EditableMode = CSCL.Controls.SourceGrid.EditableMode.Focus|CSCL.Controls.SourceGrid.EditableMode.AnyKey|CSCL.Controls.SourceGrid.EditableMode.SingleClick;
			grid1[0,6] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("COUNTRY (string + combobox)");

			mEditor_Price = new CSCL.Controls.SourceGrid.Cells.Editors.TextBoxCurrency(typeof(double));
			mEditor_Price.EditableMode = CSCL.Controls.SourceGrid.EditableMode.Focus|CSCL.Controls.SourceGrid.EditableMode.AnyKey|CSCL.Controls.SourceGrid.EditableMode.SingleClick;
			grid1[0,7] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("$ PRICE (double)");

			grid1[0,8] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("Selected");

			grid1[0,9] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("WebSite");
			#endregion
			...
			foreach(System.Xml.XmlNode l_Node in rows)
			{
				...
				grid1[rowsCount,0] = new CSCL.Controls.SourceGrid.Cells.RowHeader(null);

				grid1[rowsCount,1] = new CSCL.Controls.SourceGrid.Cells.Cell(rowsCount, mEditor_Id);

				grid1[rowsCount,2] = new CSCL.Controls.SourceGrid.Cells.Cell(l_Node.Attributes["ContactName"].InnerText, mEditor_Name);

				grid1[rowsCount,3] = new CSCL.Controls.SourceGrid.Cells.Cell(l_Node.Attributes["Address"].InnerText, mEditor_Address);

				grid1[rowsCount,4] = new CSCL.Controls.SourceGrid.Cells.Cell(l_Node.Attributes["City"].InnerText, mEditor_City);

				grid1[rowsCount,5] = new CSCL.Controls.SourceGrid.Cells.Cell(DateTime.Today, mEditor_BirthDay);

				grid1[rowsCount,6] = new CSCL.Controls.SourceGrid.Cells.Cell(l_Node.Attributes["Country"].InnerText, mEditor_Country);

				grid1[rowsCount,7] = new CSCL.Controls.SourceGrid.Cells.Cell(25.0, mEditor_Price);
                grid1[rowsCount, 7].View = mView_Price;

				grid1[rowsCount,8] = new CSCL.Controls.SourceGrid.Cells.CheckBox(null, false);

				grid1[rowsCount,9] = new CSCL.Controls.SourceGrid.Cells.Link(l_Node.Attributes["website"].InnerText);
		...
		private void brAddRow_Click(object sender, System.EventArgs e)
		{
            ...
            grid1[row, 0] = new CSCL.Controls.SourceGrid.Cells.RowHeader(null);
            grid1[row, 1] = new CSCL.Controls.SourceGrid.Cells.Cell(grid1.RowsCount, mEditor_Id);
			grid1[row, 2] = new CSCL.Controls.SourceGrid.Cells.Cell(mEditor_Name.DefaultValue, mEditor_Name);
			grid1[row, 3] = new CSCL.Controls.SourceGrid.Cells.Cell(mEditor_Address.DefaultValue,mEditor_Address);
			grid1[row, 4] = new CSCL.Controls.SourceGrid.Cells.Cell(mEditor_City.DefaultValue,mEditor_City);
			grid1[row, 5] = new CSCL.Controls.SourceGrid.Cells.Cell(mEditor_BirthDay.DefaultValue, mEditor_BirthDay);
			grid1[row, 6] = new CSCL.Controls.SourceGrid.Cells.Cell(mEditor_Country.DefaultValue, mEditor_Country);
			grid1[row, 7] = new CSCL.Controls.SourceGrid.Cells.Cell(mEditor_Price.DefaultValue, mEditor_Price);
			grid1[row, 8] = new CSCL.Controls.SourceGrid.Cells.CheckBox(null, false);

            CSCL.Controls.SourceGrid.Cells.Link link = new CSCL.Controls.SourceGrid.Cells.Link("http://www.codeproject.com");
		...
		private void btRemoveRow_Click(object sender, System.EventArgs e)
		{
			...
			CSCL.Controls.SourceGrid.RowInfo[] rows = new CSCL.Controls.SourceGrid.RowInfo[rowsIndex.Length];
			for (int i = 0; i < rows.Length; i++)
				rows[i] = grid1.Rows[rowsIndex[i]];

			foreach (CSCL.Controls.SourceGrid.RowInfo r in rows)
		...
		private void btExportHTML_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				{
					CSCL.Controls.SourceGrid.Exporter.HTML html = new CSCL.Controls.SourceGrid.Exporter.HTML(CSCL.Controls.SourceGrid.Exporter.ExportHTMLMode.Default, System.IO.Path.GetTempPath(), "", l_Stream);
					html.Export(grid1);
					l_Stream.Close();
				}
		...
		private void mController_Link_Click(object sender, EventArgs e)
		{
			try
			{
				...
				DevAge.Shell.Utilities.OpenFile( ((CSCL.Controls.SourceGrid.Cells.Link)context.Cell).Value.ToString());
			}
			catch(Exception)
			{
			}
		...
		private void chkEditOnDoubleClick_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				mEditor_Id.EditableMode = CSCL.Controls.SourceGrid.EditableMode.AnyKey | CSCL.Controls.SourceGrid.EditableMode.DoubleClick | CSCL.Controls.SourceGrid.EditableMode.F2Key;
				mEditor_Name.EditableMode = CSCL.Controls.SourceGrid.EditableMode.AnyKey | CSCL.Controls.SourceGrid.EditableMode.DoubleClick | CSCL.Controls.SourceGrid.EditableMode.F2Key;
				mEditor_Address.EditableMode = CSCL.Controls.SourceGrid.EditableMode.AnyKey | CSCL.Controls.SourceGrid.EditableMode.DoubleClick | CSCL.Controls.SourceGrid.EditableMode.F2Key;
				mEditor_City.EditableMode = CSCL.Controls.SourceGrid.EditableMode.AnyKey | CSCL.Controls.SourceGrid.EditableMode.DoubleClick | CSCL.Controls.SourceGrid.EditableMode.F2Key;
				mEditor_BirthDay.EditableMode = CSCL.Controls.SourceGrid.EditableMode.AnyKey | CSCL.Controls.SourceGrid.EditableMode.DoubleClick | CSCL.Controls.SourceGrid.EditableMode.F2Key;
				mEditor_Country.EditableMode = CSCL.Controls.SourceGrid.EditableMode.AnyKey | CSCL.Controls.SourceGrid.EditableMode.DoubleClick | CSCL.Controls.SourceGrid.EditableMode.F2Key;
				mEditor_Price.EditableMode = CSCL.Controls.SourceGrid.EditableMode.AnyKey | CSCL.Controls.SourceGrid.EditableMode.DoubleClick | CSCL.Controls.SourceGrid.EditableMode.F2Key;
			}
			else
			{
				mEditor_Id.EditableMode = CSCL.Controls.SourceGrid.EditableMode.Focus|CSCL.Controls.SourceGrid.EditableMode.AnyKey|CSCL.Controls.SourceGrid.EditableMode.SingleClick;
        ...
        private void btExportCsv_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    CSCL.Controls.SourceGrid.Exporter.CSV csv = new CSCL.Controls.SourceGrid.Exporter.CSV();
        ...
        private void btExportImage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CSCL.Controls.SourceGrid.Exporter.Image image = new CSCL.Controls.SourceGrid.Exporter.Image();
        ...
        public class KeyDeleteController : CSCL.Controls.SourceGrid.Cells.Controllers.ControllerBase
        {
            public override void OnKeyDown(CSCL.Controls.SourceGrid.CellContext sender, KeyEventArgs e)
            {
                base.OnKeyDown(sender, e);

                if (e.KeyCode == Keys.Delete)
                {
                    CSCL.Controls.SourceGrid.Grid grid = (CSCL.Controls.SourceGrid.Grid)sender.Grid;
