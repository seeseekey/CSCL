...
namespace WindowsFormsSample
{
	...
	public class frmSample28 : System.Windows.Forms.Form
	{
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			//ColumnHeader view
			CSCL.Controls.SourceGrid.Cells.Views.ColumnHeader viewColumnHeader = new CSCL.Controls.SourceGrid.Cells.Views.ColumnHeader();
			...
			//Editors
			CSCL.Controls.SourceGrid.Cells.Editors.TextBox editorString=new CSCL.Controls.SourceGrid.Cells.Editors.TextBox(typeof(string));
			CSCL.Controls.SourceGrid.Cells.Editors.TextBoxUITypeEditor editorDateTime=new CSCL.Controls.SourceGrid.Cells.Editors.TextBoxUITypeEditor(typeof(DateTime));
			...
			CSCL.Controls.SourceGrid.Cells.ColumnHeader columnHeader;

			columnHeader = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("String");
			columnHeader.View = viewColumnHeader;
			grid1[0,0] = columnHeader;

			columnHeader = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("DateTime");
			columnHeader.View = viewColumnHeader;
			grid1[0,1] = columnHeader;

			columnHeader = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("CheckBox");
			columnHeader.View = viewColumnHeader;
			...
			for (int r = 1; r < 10; r++)
			{
				...
				grid1[r,0] = new CSCL.Controls.SourceGrid.Cells.Cell("Hello " + r.ToString());
				grid1[r,0].Editor = editorString;

				grid1[r,1] = new CSCL.Controls.SourceGrid.Cells.Cell(DateTime.Today);
		...
		private class CellBackColorAlternate:CSCL.Controls.SourceGrid.Cells.Views.Cell
        {
			...
			protected override void PrepareView(CSCL.Controls.SourceGrid.CellContext context)
            {
		...
		private class CheckBoxBackColorAlternate:CSCL.Controls.SourceGrid.Cells.Views.CheckBox
        {
