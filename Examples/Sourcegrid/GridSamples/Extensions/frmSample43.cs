...
namespace WindowsFormsSample
{
	...
	public class frmSample43 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGrid.SpecialKeys = CSCL.Controls.SourceGrid.GridSpecialKeys.Default;
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			dataGrid.SelectionMode = CSCL.Controls.SourceGrid.GridSelectionMode.Row;
			...
			//TODO Drag and drop
			//dataGrid.GridController.AddController(CSCL.Controls.SourceGrid.Controllers.SelectionDrag.Copy);
			//dataGrid.GridController.AddController(CSCL.Controls.SourceGrid.Controllers.SelectionDrop.Default);

			dataGrid.ClipboardMode = CSCL.Controls.SourceGrid.ClipboardMode.All;
		}
