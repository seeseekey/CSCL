...
namespace WindowsFormsSample
{
	...
	public class frmSample29 : System.Windows.Forms.Form
	{
		...
		private void frmSample29_Load(object sender, System.EventArgs e)
		{
			...
			//Header row
			dataGrid.Columns.Insert(0, CSCL.Controls.SourceGrid.DataGridColumn.CreateRowHeader(dataGrid));
		...
		private void CreateColumns(CSCL.Controls.SourceGrid.DataGridColumns columns,
		                           DevAge.ComponentModel.IBoundList bindList)
		{
			...
			//Standard Views
			CSCL.Controls.SourceGrid.Cells.Views.Link viewLink = new CSCL.Controls.SourceGrid.Cells.Views.Link();
			...
			CSCL.Controls.SourceGrid.Cells.Views.Cell viewString = new CSCL.Controls.SourceGrid.Cells.Views.Cell();
			...
			CSCL.Controls.SourceGrid.Cells.Views.Cell viewNumeric = new CSCL.Controls.SourceGrid.Cells.Views.Cell();
			...
			CSCL.Controls.SourceGrid.Cells.Views.Cell viewImage = new CSCL.Controls.SourceGrid.Cells.Views.Cell();
			...
			gridColumn = dataGrid.Columns.Add(null, "", new CSCL.Controls.SourceGrid.Cells.Link());
			gridColumn.DataCell.AddController(new LinkClickDelete());
			gridColumn.DataCell.View = viewLink;
			((CSCL.Controls.SourceGrid.Cells.Link)gridColumn.DataCell).Image = Properties.Resources.trash.ToBitmap();

			gridColumn = dataGrid.Columns.Add("Flag", "Flag", new CSCL.Controls.SourceGrid.Cells.DataGrid.Image());
			...
			foreach (CSCL.Controls.SourceGrid.DataGridColumn col in columns)
			{
				CSCL.Controls.SourceGrid.Conditions.ICondition condition =
					CSCL.Controls.SourceGrid.Conditions.ConditionBuilder.AlternateView(col.DataCell.View,
		...
		private class LinkClickDelete : CSCL.Controls.SourceGrid.Cells.Controllers.ControllerBase
		{
			public override void OnClick(CSCL.Controls.SourceGrid.CellContext sender, EventArgs e)
			{
				base.OnClick(sender, e);

				CSCL.Controls.SourceGrid.DataGrid grid = (CSCL.Controls.SourceGrid.DataGrid)sender.Grid;
