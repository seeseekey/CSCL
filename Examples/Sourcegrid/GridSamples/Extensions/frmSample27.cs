...
namespace WindowsFormsSample
{
	...
	public class frmSample27 : System.Windows.Forms.Form
	{
		...
		private CSCL.Controls.SourceGrid.ArrayGrid arrayGrid;
		/// <summary>
		...
		public frmSample27()
		{
			...
			new CSCL.Controls.SourceGrid.ArrayGrid();
		}
		...
		private void InitializeComponent()
		{
			...
			this.arrayGrid = new CSCL.Controls.SourceGrid.ArrayGrid();
			this.SuspendLayout();
			// 
			// label3
			// 
			...
			this.arrayGrid.SpecialKeys = CSCL.Controls.SourceGrid.GridSpecialKeys.Default;
