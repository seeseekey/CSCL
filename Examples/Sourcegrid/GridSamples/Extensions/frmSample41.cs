...
namespace WindowsFormsSample
{
	...
	{
		private CSCL.Controls.SourceGrid.DataGrid dataGrid;
		...
		{
            this.dataGrid = new CSCL.Controls.SourceGrid.DataGrid();
            ...
            this.dataGrid.SelectionMode = CSCL.Controls.SourceGrid.GridSelectionMode.Row;
		...
		private void frmSample41_Load(object sender, System.EventArgs e)
		{
            ...
            dataGrid.Selection.SelectionChanged += new CSCL.Controls.SourceGrid.RangeRegionChangedEventHandler(Selection_SelectionChanged);
		}

		void Selection_SelectionChanged(object sender, CSCL.Controls.SourceGrid.RangeRegionChangedEventArgs e)
        {
		...
		{
            //Create the editors
			CSCL.Controls.SourceGrid.Cells.Editors.TextBoxNumeric numericEditor = new CSCL.Controls.SourceGrid.Cells.Editors.TextBoxNumeric(typeof(decimal));
			...
			CSCL.Controls.SourceGrid.Cells.Editors.ComboBox externalIdEditor = new CSCL.Controls.SourceGrid.Cells.Editors.ComboBox(typeof(int));
            ...
            //Create the views
            CSCL.Controls.SourceGrid.Cells.Views.Cell viewSelected = new CSCL.Controls.SourceGrid.Cells.Views.Cell();
            viewSelected.Font = new Font(dataGrid.Font, FontStyle.Bold);
            viewSelected.ForeColor = Color.DarkGreen;

            //Create selected conditions
            CSCL.Controls.SourceGrid.Conditions.ConditionView selectedConditionBold = new CSCL.Controls.SourceGrid.Conditions.ConditionView(viewSelected);
            selectedConditionBold.EvaluateFunction = delegate(CSCL.Controls.SourceGrid.DataGridColumn column, int gridRow, object itemRow)
                                                    {
                                                        DataRowView row = (DataRowView)itemRow;
                                                        return row["Selected"] is bool && (bool)row["Selected"] == true;
                                                    };
            CSCL.Controls.SourceGrid.Conditions.ConditionCell selectedConditionStar = new CSCL.Controls.SourceGrid.Conditions.ConditionCell(new CSCL.Controls.SourceGrid.Cells.Virtual.CellVirtual());
            selectedConditionStar.Cell.Model.AddModel(new CSCL.Controls.SourceGrid.Cells.Models.Image(Properties.Resources.Star.ToBitmap()));
            selectedConditionStar.EvaluateFunction = delegate(CSCL.Controls.SourceGrid.DataGridColumn column, int gridRow, object itemRow)
                                                    {
                                                        DataRowView row = (DataRowView)itemRow;
                                                        return row["Selected"] is bool && (bool)row["Selected"] == true;
                                                    };
			...
			//Create columns
            CSCL.Controls.SourceGrid.DataGridColumn gridColumn;
            ...
            gridColumn = dataGrid.Columns.Add("Uniform", "Uniform", new CSCL.Controls.SourceGrid.Cells.DataGrid.Image());
            gridColumn.Conditions.Add(selectedConditionBold);
            ...
            gridColumn = dataGrid.Columns.Add("Star", "Star", new CSCL.Controls.SourceGrid.Cells.Virtual.CellVirtual());
            gridColumn.DataCell.Model.AddModel(new CSCL.Controls.SourceGrid.Cells.Models.Image(Properties.Resources.StarOff));
            gridColumn.Conditions.Add(selectedConditionStar);

            foreach (CSCL.Controls.SourceGrid.DataGridColumn col in dataGrid.Columns)
            {
                col.DataCell.AddController(CSCL.Controls.SourceGrid.Cells.Controllers.ToolTipText.Default);
                col.DataCell.Model.AddModel(MyToolTipModel.Default);
            }
		}

        public class BoundImage : CSCL.Controls.SourceGrid.Cells.Models.IImage
        {
            ...
            public System.Drawing.Image GetImage(CSCL.Controls.SourceGrid.CellContext cellContext)
            {
                CSCL.Controls.SourceGrid.DataGrid dg = (CSCL.Controls.SourceGrid.DataGrid)cellContext.Grid;
        ...
        private class MyToolTipModel : CSCL.Controls.SourceGrid.Cells.Models.IToolTipText
        {
            public static readonly MyToolTipModel Default = new MyToolTipModel();

            public string GetToolTipText(CSCL.Controls.SourceGrid.CellContext cellContext)
            {
                CSCL.Controls.SourceGrid.DataGrid grid = (CSCL.Controls.SourceGrid.DataGrid)cellContext.Grid;
