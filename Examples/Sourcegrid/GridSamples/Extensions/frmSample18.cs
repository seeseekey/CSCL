...
namespace WindowsFormsSample
{
	...
	public class frmSample18 : System.Windows.Forms.Form
	{
		...
		private CSCL.Controls.SourceGrid.ListEditor listEditor1;
		...
		private CSCL.Controls.SourceGrid.Planning.PlanningGrid planningGrid1;
		...
		private void InitializeComponent()
		{
            ...
            this.planningGrid1 = new CSCL.Controls.SourceGrid.Planning.PlanningGrid();
            this.splitter1 = new System.Windows.Forms.Splitter();
            this.listEditor1 = new CSCL.Controls.SourceGrid.ListEditor();
            ...
            this.planningGrid1.AppointmentClick += new CSCL.Controls.SourceGrid.Planning.PlanningGrid.AppointmentEventHandler(this.planningGrid1_AppointmentClick);
            this.planningGrid1.AppointmentDoubleClick += new CSCL.Controls.SourceGrid.Planning.PlanningGrid.AppointmentEventHandler(this.planningGrid1_AppointmentDoubleClick);
            // 
            // splitter1
            // 
		...
		private void frmSample18_Load(object sender, System.EventArgs e)
		{
			...
			listEditor1.ItemType = typeof(CSCL.Controls.SourceGrid.Planning.AppointmentBase);

            CSCL.Controls.SourceGrid.Planning.IAppointment appointment1 = new CSCL.Controls.SourceGrid.Planning.AppointmentBase("Dentist",
                                    new DateTime(now.Year, now.Month, now.Day, 9, 0, 0),
                                    new DateTime(now.Year, now.Month, now.Day, 11, 30, 0));
            CSCL.Controls.SourceGrid.Planning.IAppointment appointment2 = new CSCL.Controls.SourceGrid.Planning.AppointmentBase("Appointment 1",
		...
		private void LoadPlanning()
		{
			try
			{
				...
				foreach (CSCL.Controls.SourceGrid.Planning.AppointmentBase a in listEditor1.List)
				{
        ...
        private void planningGrid1_AppointmentClick(object sender, CSCL.Controls.SourceGrid.Planning.AppointmentEventArgs e)
        {
            //TODO Add your code here
        }

		private void planningGrid1_AppointmentDoubleClick(object sender, CSCL.Controls.SourceGrid.Planning.AppointmentEventArgs e)
        {
