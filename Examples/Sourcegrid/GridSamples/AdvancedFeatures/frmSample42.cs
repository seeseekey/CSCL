...
namespace WindowsFormsSample
{
	...
	public class frmSample42 : System.Windows.Forms.Form
	{
		...
		private class EditableColumnHeader : CSCL.Controls.SourceGrid.Cells.ColumnHeader
		{
			...
			{
				//Set the editor
				CSCL.Controls.SourceGrid.Cells.Editors.TextBox headerEditor = new CSCL.Controls.SourceGrid.Cells.Editors.TextBox(typeof(string));
				headerEditor.EditableMode = CSCL.Controls.SourceGrid.EditableMode.None;
				Editor = headerEditor;
				...
				RemoveController(CSCL.Controls.SourceGrid.Cells.Controllers.Unselectable.Default);
			}

			private class RightClickEditing:CSCL.Controls.SourceGrid.Cells.Controllers.ControllerBase
			{
				public override void OnMouseDown(CSCL.Controls.SourceGrid.CellContext sender, MouseEventArgs e)
				{
