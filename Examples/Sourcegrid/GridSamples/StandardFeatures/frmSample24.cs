...
namespace WindowsFormsSample.GridSamples
{
	...
	public class frmSample24 : System.Windows.Forms.Form
	{
		...
		private CSCL.Controls.SourceGrid.Grid grid2;
		...
		private void InitializeComponent()
		{
            ...
            this.grid2 = new CSCL.Controls.SourceGrid.Grid();
            ...
            this.grid2.OptimizeMode = CSCL.Controls.SourceGrid.CellOptimizeMode.ForRows;
            this.grid2.SelectionMode = CSCL.Controls.SourceGrid.GridSelectionMode.Cell;
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			for (int r = 0; r < grid1.RowsCount; r++)
				for (int c = 0; c < grid1.ColumnsCount; c++)
					grid1[r, c] = new CSCL.Controls.SourceGrid.Cells.Cell(rnd.NextDouble(), typeof(double));

			for (int r = 0; r < grid2.RowsCount; r++)
				for (int c = 0; c < grid2.ColumnsCount; c++)
					grid2[r, c] = new CSCL.Controls.SourceGrid.Cells.Cell("str" + r.ToString(), typeof(string));


            grid1.ClipboardMode = CSCL.Controls.SourceGrid.ClipboardMode.All;
            grid2.ClipboardMode = CSCL.Controls.SourceGrid.ClipboardMode.All;
		}
