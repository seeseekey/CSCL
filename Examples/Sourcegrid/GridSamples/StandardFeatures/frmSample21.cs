...
using CSCL.Controls.SourceGrid.Cells.Controllers;
...
namespace WindowsFormsSample
{
	...
	public class frmSample21 : System.Windows.Forms.Form
	{
		...
		private void DoFull()
		{
			...
			CSCL.Controls.SourceGrid.Cells.Controllers.CustomEvents clickEvent = new CSCL.Controls.SourceGrid.Cells.Controllers.CustomEvents();
			clickEvent.Click += new EventHandler(clickEvent_Click);

			for (int r = 2; r < grid1.RowsCount; r=r+2)
			{
				grid1[r, 0] = new CSCL.Controls.SourceGrid.Cells.Cell(r.ToString(), typeof(string));
				grid1[r, 0].ColumnSpan = 2;

				grid1[r+1, 0] = new CSCL.Controls.SourceGrid.Cells.Cell();
				grid1[r+1, 0].ColumnSpan = 2;

				grid1[r, 2] = new CSCL.Controls.SourceGrid.Cells.CheckBox("CheckBox Column/Row Span", false);
				grid1[r, 2].ColumnSpan = 2;
				grid1[r, 2].RowSpan = 2;

				grid1[r, 4] = new CSCL.Controls.SourceGrid.Cells.Link("Link Column/Row Span");
				grid1[r, 4].ColumnSpan = 2;
				grid1[r, 4].RowSpan = 2;
				grid1[r, 4].AddController(clickEvent);

				grid1[r, 6] = new CSCL.Controls.SourceGrid.Cells.Button("Button Column/Row Span");
				grid1[r, 6].ColumnSpan = 2;
				grid1[r, 6].RowSpan = 2;
				grid1[r, 6].AddController(clickEvent);

				grid1[r, 8] = new CSCL.Controls.SourceGrid.Cells.Cell("Image Column/Row Span");
				grid1[r, 8].View = viewImage;
				grid1[r, 8].Image = Properties.Resources.FACE02.ToBitmap();
				grid1[r, 8].ColumnSpan = 2;
				grid1[r, 8].RowSpan = 2;
				
				grid1[r, 10] = new CSCL.Controls.SourceGrid.Cells.Cell("Text Span", typeof(string));
		...
		private class MyHeader : CSCL.Controls.SourceGrid.Cells.ColumnHeader
		{
			public MyHeader(object value):base(value)
			{
				//1 Header Row
				CSCL.Controls.SourceGrid.Cells.Views.ColumnHeader view = new CSCL.Controls.SourceGrid.Cells.Views.ColumnHeader();
