using CSCL.Controls.SourceGrid.Selection;
using System;
...
namespace WindowsFormsSample
{
	...
	public class frmSample17 : System.Windows.Forms.Form
	{
		...
		private void frmSample17_Load(object sender, System.EventArgs e)
		{
			...
			grid1[0,0] = new CSCL.Controls.SourceGrid.Cells.Header(null);
			for (int c = 1; c < grid1.ColumnsCount; c++)
			{
				CSCL.Controls.SourceGrid.Cells.ColumnHeader header = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("Header " + c.ToString());
			...
			{
				grid1[r,0] = new CSCL.Controls.SourceGrid.Cells.RowHeader("Header " + r.ToString());
				for (int c = 1; c < grid1.ColumnsCount; c++)
				{
					if (rnd.NextDouble() > 0.20)
					{
						grid1[r,c] = new CSCL.Controls.SourceGrid.Cells.Cell(r*c, typeof(int));
					}
					else
						grid1[r,c] = null;
				}
		...
		private void Check_Change(object sender, System.EventArgs e)
		{
			if (rdSelectionModeCell.Checked)
				grid1.SelectionMode = CSCL.Controls.SourceGrid.GridSelectionMode.Cell;
				...
				grid1.SelectionMode = CSCL.Controls.SourceGrid.GridSelectionMode.Column;
		}
