...
namespace WindowsFormsSample
{
	...
	public class frmSample26 : System.Windows.Forms.Form
	{
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
            ...
            CSCL.Controls.SourceGrid.Cells.Controllers.ToolTipText toolTipController = new CSCL.Controls.SourceGrid.Cells.Controllers.ToolTipText();
			...
			for (int r = 0; r < grid1.Rows.Count; r++)
			{
				if (r == 0)
				{
					grid1[r, 0] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("Click event");
					grid1[r, 1] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("Custom Cursor");
					grid1[r, 2] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("ContextMenu");
                    grid1[r, 3] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("ToolTip");
                    grid1[r, 4] = new CSCL.Controls.SourceGrid.Cells.ColumnHeader("ValueChanged");
                }
				else
				{
					grid1[r, 0] = new CSCL.Controls.SourceGrid.Cells.Cell("Value " + r.ToString(), typeof(string));
					grid1[r, 1] = new CSCL.Controls.SourceGrid.Cells.Cell(DateTime.Now, typeof(DateTime));
					grid1[r, 2] = new CSCL.Controls.SourceGrid.Cells.Cell("Right click");
                    grid1[r, 3] = new CSCL.Controls.SourceGrid.Cells.Cell("Value " + r.ToString());
                    grid1[r, 3].ToolTipText = "Example of tooltip, bla bla bla ....\n Row: " + r.ToString();
                    grid1[r, 4] = new CSCL.Controls.SourceGrid.Cells.Cell("Value " + r.ToString(), typeof(string));
                }
	...
	public class CellCursor:CSCL.Controls.SourceGrid.Cells.Controllers.MouseCursor
	{
	...
	public class PopupMenu:CSCL.Controls.SourceGrid.Cells.Controllers.ControllerBase
	{
		...
		public override void OnMouseUp(CSCL.Controls.SourceGrid.CellContext sender, MouseEventArgs e)
		{
	...
	public class CellClickEvent:CSCL.Controls.SourceGrid.Cells.Controllers.ControllerBase
	{
	...
	public class ValueChangedEvent:CSCL.Controls.SourceGrid.Cells.Controllers.ControllerBase
    {
	...
	public class KeyEvent:CSCL.Controls.SourceGrid.Cells.Controllers.ControllerBase
    {
