...
namespace WindowsFormsSample
{
	...
	public class frmSample19 : System.Windows.Forms.Form
	{
		...
		private void frmSample19_Load(object sender, System.EventArgs e)
		{
			...
			CSCL.Controls.SourceGrid.Cells.Views.Cell transparentView = new CSCL.Controls.SourceGrid.Cells.Views.Cell();
			transparentView.BackColor = Color.Transparent;
			CSCL.Controls.SourceGrid.Cells.Views.Cell semiTransparentView = new CSCL.Controls.SourceGrid.Cells.Views.Cell();
			...
			for (int r = 0; r < grid1.RowsCount; r++)
				for (int c = 0; c < grid1.ColumnsCount; c++)
				{
					if (rnd.Next(0,100) < 50)
						grid1[r,c] = new CSCL.Controls.SourceGrid.Cells.Cell("Opaque");
					else if (rnd.Next(0,100) < 75)
					{
						CSCL.Controls.SourceGrid.Cells.Cell l_Cell = new CSCL.Controls.SourceGrid.Cells.Cell("Transparent");
						l_Cell.View = transparentView;
						grid1[r,c] = l_Cell;
					}
					else
					{
						CSCL.Controls.SourceGrid.Cells.Cell l_Cell = new CSCL.Controls.SourceGrid.Cells.Cell("Transparent 50");
